...
// ==== FUNGSI POINTER ====
void ubahPassword(User* user) { // address-of
    cout << "Masukkan password baru: ";
    cin >> user->password;
    cout << "Password berhasil diubah!\n";
}

void tampilkanUser(const User* user) { // dereference
    cout << "\n--- Info Akun ---\n";
    ...
    while (true) {
        ...
        while (loginIndex != -1) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    lihatKamarTersedia(daftarKamar, kamarCount); break;
                case 3:
                    ubahPassword(&daftarUser[loginIndex]); break;
                case 4:
                    tampilkanUser(&daftarUser[loginIndex]); break;
                case 5:
                    loginIndex = -1;
